...
<div class="form-view box box-big box-light">
    ...
    <div class="pull-right hidden-xs" style="margin-top: -5px">
        ...
        <?php if (!empty(Yii::$app->user) && Yii::$app->user->can("edit_own_content")) : // Advanced user ?>
            ...
            <?= Html::a('<span class="glyphicon glyphicon-refresh"></span> ', ['reset-stats', 'id' => $formModel->id], [
                ...
                'data' => [
                    'confirm' => Yii::t('app', 'Are you sure you want to delete these stats? All stats related to this item will be deleted. This action cannot be undone.'),
                    'method' => 'post',
                ],
            ]) ?>
            <?= Html::a('<span class="glyphicon glyphicon-bin"></span> ', ['delete', 'id' => $formModel->id], [
                ...
                'class' => 'btn btn-sm btn-danger',
                'data' => [
                    'confirm' => Yii::t('app', 'Are you sure you want to delete this form? All stats, submissions, conditional rules and reports data related to this item will be deleted. This action cannot be undone.'),
                    'method' => 'post',
                ],
            ]) ?>
            </div>
    ...
    <div class="buttons visible-xs-block">
        ...
        <div class="btn-group" role="group">
            <?= Html::a(
                '<span class="glyphicon glyphicon-refresh"></span> ' . Yii::t('app', 'Reset Stats'),
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'value' => $formModel->lastEditor->username,
